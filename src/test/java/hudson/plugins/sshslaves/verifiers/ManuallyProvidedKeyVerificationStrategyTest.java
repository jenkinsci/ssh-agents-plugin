 ...
 */
class ManuallyProvidedKeyVerificationStrategyTest {
    ...
    void testRsa() throws IOException {
        ...
        assertArrayEquals(new String[]{"ssh-rsa", "ssh-ed25519", "ecdsa-sha2-nistp521", "ecdsa-sha2-nistp384", "ecdsa-sha2-nistp256", "rsa-sha2-256", "rsa-sha2-512",  "ssh-dss"}, testCase.getPreferredKeyAlgorithms(null));
    }
    ...
    void testEd25519() throws IOException {
        ...
        assertArrayEquals(new String[]{"ssh-ed25519", "ecdsa-sha2-nistp521", "ecdsa-sha2-nistp384", "ecdsa-sha2-nistp256", "rsa-sha2-256", "rsa-sha2-512", "ssh-rsa", "ssh-dss"}, testCase.getPreferredKeyAlgorithms(null));
    }


    @Test
    void testEcdsa() throws IOException {
        ...
        assertArrayEquals(new String[]{"ecdsa-sha2-nistp256", "ssh-ed25519", "ecdsa-sha2-nistp521", "ecdsa-sha2-nistp384", "rsa-sha2-256", "rsa-sha2-512", "ssh-rsa", "ssh-dss"}, testCase.getPreferredKeyAlgorithms(null));
    }
    ...
    void testDsa() throws IOException {
        ...
        assertArrayEquals(new String[]{"ssh-dss", "ssh-ed25519", "ecdsa-sha2-nistp521", "ecdsa-sha2-nistp384", "ecdsa-sha2-nistp256", "rsa-sha2-256", "rsa-sha2-512", "ssh-rsa"}, testCase.getPreferredKeyAlgorithms(null));
    }
