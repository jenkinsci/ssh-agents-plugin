...
class AgentRSA256ConnectionTest extends AgentConnectionBaseTest {
  private static final String SSH_AGENT_NAME = "ssh-agent-rsa256";
  private static final String SSH_KEY_PATH = "ssh/rsa-256-key";
  private static final String SSH_KEY_PUB_PATH = "ssh/rsa-256-key.pub";
