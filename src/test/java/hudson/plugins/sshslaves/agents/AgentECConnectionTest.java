...
class AgentECConnectionTest extends AgentConnectionBaseTest {
    private static final String SSH_AGENT_NAME = "ssh-agent-ec";
    private static final String SSH_KEY_PATH = "ssh/ecdsakey";
    private static final String SSH_KEY_PUB_PATH = "ssh/ecdsakey.pub";
