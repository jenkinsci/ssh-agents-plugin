...
class AgentRSA512ConnectionTest extends AgentConnectionBaseTest {
    private static final String SSH_AGENT_NAME = "ssh-agent-rsa512";
    private static final String SSH_KEY_PATH = "ssh/rsa-512-key";
    private static final String SSH_KEY_PUB_PATH = "ssh/rsa-512-key.pub";
